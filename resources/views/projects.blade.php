...
<div id="vanta-bg" class="min-h-screen" x-data="{ modalOpen: false, modalImage: '' }">
  ...
  <ul class="flex gap-6 text-sm md:text-base">
    ...
    <li><a href="{{ url('/certifications') }}" class="hover:text-purple-300 transition-transform transform duration-300 hover:scale-110 hover:drop-shadow-[0_0_8px_#c084fc]">Certifications</a></li>
    <li><a href="{{ url('/test') }}" class="hover:text-purple-300 transition-transform transform duration-300 hover:scale-110 hover:drop-shadow-[0_0_8px_#c084fc]">Honors & Awards</a></li>
    ...
    <div class="grid gap-10 max-w-7xl mx-auto text-left sm:grid-cols-2 lg:grid-cols-3">
      ...
      <div class="bg-black/60 border border-purple-400/20 rounded-xl p-6 shadow-lg hover:shadow-[0_0_12px_#a855f7] hover:scale-[1.03] transition-transform duration-500" data-aos="zoom-in" data-aos-duration="700">
        ...
        <div class="flex flex-wrap gap-4 text-base font-medium mb-4">
          <a href="#" class="text-purple-300 underline hover:scale-105 hover:drop-shadow-[0_0_6px_#9333ea] transition-transform">Live Demo</a>
